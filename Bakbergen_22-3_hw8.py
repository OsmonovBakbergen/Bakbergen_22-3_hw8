...
def create_products(conn):
    try:
        create_product(conn, ("Молоко", 500.5, 7))
        create_product(conn, ("Сосиски", 250.4, 26))
        create_product(conn, ("Колбаса", 300.5, 16))
        create_product(conn, ("Хлеб", 30.5, 50))
        create_product(conn, ("Майонез", 125.5, 25))
        create_product(conn, ("Кофе", 15.5, 30))
        create_product(conn, ("Кефир", 50.5, 15))
        create_product(conn, ("Насвай", 5.5, 10))
        create_product(conn, ("Водка Белинкая", 220.5, 5))
        create_product(conn, ("Coca-Cola", 85.5, 12))
        create_product(conn, ("Fanta", 85.5, 12))
        create_product(conn, ("Pepsi", 110.5, 12))
        create_product(conn, ("Сникерс", 30.6, 20))
        create_product(conn, ("Баунти", 27.3, 20))
...
if connection is not None:
    ...
    search_by_word(connection, "Кофе")
